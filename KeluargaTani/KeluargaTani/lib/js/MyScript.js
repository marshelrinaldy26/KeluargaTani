  ...
  api.columns().every(function () {
    ...
    if (booleanColumns.includes(column.index())) {
      ...
      wrapper.innerHTML = `
        ...
        <button class="bg-red-500 hover:bg-red-600 text-white rounded p-1 clear-bool ml-auto" id="clear_${column.index()}" title="Reset" style="visibility: hidden;"> <i class='material-icons '>close</i>
        </button>
      `;
    ...
    // B. Date Picker
      ...
      input.type = "date";
      input.className = "search-box-input w-full px-2 py-1.5 rounded-lg border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-xs focus:outline-none focus:border-emerald-500";
